...
<body class="d-flex h-100 text-center text-bg-dark">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        <header class="mb-auto">
            <div>
                ...
                <nav class="nav nav-masthead justify-content-center float-md-end">
                    ...
                    <a class="nav-link fw-bold py-1 px-0 active" aria-current="page" href="index.php">Executor</a>
                    <!-- <a class="nav-link fw-bold py-1 px-0" href="#">Login</a> -->
                    <!-- <a class="nav-link fw-bold py-1 px-0" href="#">Contato</a> -->
                    <!-- <a class="nav-link fw-bold py-1 px-0" href="#">Contato</a> -->
                    <a class="nav-link fw-bold py-1 px-0" href="sobre.php">Sobre</a>
                </nav>
            </div>
        </header>
        ...
        <main class="px-3">
            ...
            <br>
            <form action="gerar_excel.php" method="GET">
                <div class="form-floating">
                    <textarea type="search" name="query" class="form-control" placeholder=""
                        id="floatingTextarea2" style="height: 200px"></textarea>
                    <label for="floatingTextarea2" style="color: #333">Código da query</label>
                </div>
                <br>
                ...
                <p class="lead">
                    ...
                    <button type="submit" name="gerar-planilha" id="btn-color" class="btn btn-outline-light btn-lg">Gerar
                        Planilha</button>
                    <!-- <a href="#" name="limpar" class="btn btn-outline-danger btn-lg">Limpar</a> -->
                </p>
            </form>
        </main>
                ...
                <div class="modal-dialog">
                    <div class="modal-content" style="background-color: rgb(51, 51, 51);">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel" style="color: #fafafa;">Contatos</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body" style="color: #fafafa;">
                            <h5>Para mais informações entre em contato com:</h5>
                            gustavo.alves@seguralta.com.br<br>raul.dev@seguralta.com.br<br>joao.dev@seguralta.com.br
                        </div>
